    ...
    public partial class InitialPostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "BillProviders",
                columns: new[] { "Id", "Category", "Icon", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, "Electricity", "bolt", true, "City Electricity" },
                    { 2, "Water", "water_drop", true, "Regional Water Corp" },
                    { 3, "Internet", "wifi", true, "Fiber Net" },
                    { 4, "Gas", "local_fire_department", true, "Gas Services" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AvatarUrl", "CreatedAt", "Email", "FcmToken", "FullName", "IsActive", "OtpCode", "OtpExpiry", "PasswordHash", "PhoneNumber", "RefreshToken", "RefreshTokenExpiry", "Role" },
                values: new object[] { 1, null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@banke.com", null, "Admin BankE", true, null, null, "$2a$11$yvCzIpEdWOo9465RU73xn.DpuNyEdb0WgBYq.4myEl/LRuXfUQIu2", "01000000000", null, null, "Admin" });
